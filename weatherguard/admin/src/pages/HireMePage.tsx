          ...
          <div className="bg-muted/50 border-t border-border/50 px-5 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5 w-full sm:w-auto">
              <a 
                ...
                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[#229ED9] to-[#1d8ac0] text-white font-bold text-xs sm:text-sm shadow-md hover:shadow-lg transition-all active:scale-95 whitespace-nowrap"
              >
              ...
              <a 
                ...
                className="inline-flex items-center justify-center p-2.5 w-10 h-10 rounded-xl border border-[#0A66C2]/40 bg-[#0A66C2]/10 hover:bg-[#0A66C2]/20 transition-colors text-[#0A66C2] shadow-sm shrink-0"
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center p-2.5 w-10 h-10 rounded-xl border border-border bg-muted/60 hover:bg-muted transition-colors text-foreground shadow-sm shrink-0"
